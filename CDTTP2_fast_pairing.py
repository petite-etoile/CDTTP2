        ...
        for r in self.rounds:
            for t1 in self.teams[::2]:
                for t2 in self.teams:
                    ...
                    self.M.add_constraint(self.M.vars[t1,r,t2,0] ==  self.M.vars[t1_2,r,t2_2,1])
                    self.M.add_constraint(self.M.vars[t1,r,t2,1] ==  self.M.vars[t1_2,r,t2_2,0])
